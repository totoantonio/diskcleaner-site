import{j as e}from"./index-B3_g5coT.js";import{b as l}from"./router-C2Npreoe.js";const F=`<svg width="920" height="590" viewBox="0 0 920 590" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif">
  <defs>
...
</svg>`;function c({BG:t}){return l.useEffect(()=>{window.dispatchEvent(new Event("dc:reveal-refresh"))},[]),e.jsx("section",{id:"compare",className:"py-12 sm:py-20",style:{background:t},children:e.jsxs("div",{className:"mx-auto w-full max-w-[1200px] px-6 md:px-12",children:[e.jsxs("div",{className:"mb-8 flex flex-col items-center text-center sm:mb-10",children:[e.jsx("span",{className:"reveal rounded-full border border-[var(--blue-tint-border)] bg-[var(--blue-tint)] px-3 py-1 text-xs font-semibold uppercase tracking-[0.08em] text-[var(--blue)]",children:"Comparison"}),e.jsxs("h2",{className:"reveal reveal-headline d1 mt-4 text-[clamp(34px,4vw,56px)] font-bold leading-[1.04] tracking-[-0.04em] text-[var(--text)]",children:["Why DiskCleaner ",e.jsx("span",{children:"is different."})]}),e.jsxs("p",{className:"reveal d2 mt-4 max-w-[480px] text-[17px] leading-7 text-[var(--muted)]",children:["Other apps clean in the dark.",e.jsx("br",{}),"DiskCleaner puts you in the light — every file, every time."]})]}),e.jsx("div",{style:{marginBottom:48,display:"flex",justifyContent:"center"},children:e.jsx("div",{className:"reveal",style:{width:"fit-content",maxWidth:"100%",lineHeight:0,borderRadius:28,boxShadow:"0 32px 72px rgba(0,0,0,0.14)",overflow:"hidden",display:"inline-block",background:"#fff"},dangerouslySetInnerHTML:{__html:F}})}),e.jsx("div",{style:{maxWidth:760,margin:"0 auto",textAlign:"center"},children:e.jsxs("p",{style:{fontSize:"clamp(16px,2.5vw,21px)",fontWeight:400,lineHeight:1.55,letterSpacing:".011em",color:"#606f7f",margin:0},children:["DiskCleaner takes the opposite approach — show everything, delete nothing without your approval. Every file, every category, reviewed by you before anything moves. Most cleaners are black boxes. ",e.jsx("span",{style:{color:"#1d1d1f"},children:"Not this one."})]})})]})})}export{c as default};
