  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface2)] px-4 py-3">
        ...
        <p className="mt-1 text-sm text-[var(--muted)]">Current DiskCleaner releases and notable shipped changes.</p>
      </div>
      ...
      {[
          ...
          groups: [
            {
              label: "+ Added",
              items: [
                "Sparkle updater integration for in-app update checks.",
                "Secure update feed and signature verification support.",
              ],
            },
            {
              label: "• Improved",
              items: [
                "Release delivery pipeline for smoother update rollout.",
            ...
            },
            {
              label: "Install",
              items: [
                "Open the DMG, drag DiskCleaner to Applications, then launch it from Applications.",
              ],
            },
            {
              label: "Security",
        ...
        },
        {
          ...
          groups: [
            ...
            },
            {
              label: "Core Workflow",
              items: [
                "Quick Scan, Deep Scan, App Uninstaller, RAM Optimizer, Large Files scanner, and menu bar disk overview.",
                "Review-first cleanup with per-file checkboxes and Trash-first removal.",
                "Local cleanup with no app telemetry, no account requirement, and no subscription.",
              ],
            },
          ],
        },
        {
          ...
          title: "Early Foundation Milestone",
          groups: [
            {
              label: "◎ Foundation",
              items: [
        ...
        },
        {
          version: "2026.04.18",
          date: "April 18, 2026",
          title: "Developer Data Coverage Expansion",
          groups: [
            {
              label: "+ Added",
              items: [
                "Homebrew cache coverage under Developer Data, giving developers one more high-signal cleanup target to review.",
                "Additional Developer Data folder detection so more build and package-manager clutter appears in the right category.",
              ],
            },
            {
              label: "• Improved",
              items: [
                "Developer cleanup copy and category grouping for clearer scan results.",
              ],
            },
          ],
        },
        {
          version: "2026.05.05",
          date: "May 5, 2026",
          title: "Readability + Background Polish",
          groups: [
            {
              label: "• Improved",
              items: [
                "Font rendering and text sizing across key screens for more comfortable reading.",
                "Background treatments and surface contrast for a cleaner, more refined app feel.",
                "Small behind-the-scenes UI adjustments that make the app feel smoother without changing the core workflow.",
              ],
            },
          ],
        },
